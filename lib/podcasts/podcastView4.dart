...
class podcastView4 extends StatefulWidget {
  const podcastView4({Key? key}) : super(key: key);
...
class _PodcastState extends State<podcastView4> {
  ...
  Future setAudio() async {
    ...
    String url =
        'https://traffic.megaphone.fm/CAD3209010227.mp3?updated=1662588545';
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.asset('assets/home_page/Podcast4.png',
