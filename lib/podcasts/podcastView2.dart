...
class podcastView2 extends StatefulWidget {
  const podcastView2({Key? key}) : super(key: key);
...
class _PodcastState extends State<podcastView2> {
  ...
  Future setAudio() async {
    ...
    String url =
        'https://traffic.libsyn.com/mindfulorg/12MM-Oct13-Salzberg-Edited.mp3';
            ...
            child: Column(
              ...
              children: [
                ...
                ClipRRect(
                  ...
                  child: Image.asset('assets/home_page/Podcast2.png',
